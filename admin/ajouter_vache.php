...
<title>Ajouter une vache — Ferme Tarmast</title>
<style>
  :root{
    --forest: #1B3A2B;
    --forest-2: #142A20;
...
<div class="layout">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="ajouter_vache.php" class="active">
  ...
  <main class="main">
    <div class="topbar">
      <div>
        ...
        <p class="sub">Renseignez les informations du nouvel animal du cheptel.</p>
      </div>
        ...
        <div class="panel-body">
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input type="number" id="poids" name="poids" min="0" step="0.01" placeholder="ex. 420">
            </div>
            <div class="form-group">
            ...
            <div class="form-group full">
              ...
              <textarea id="description" name="description" placeholder="Origine, alimentation, état de santé, remarques utiles à l'acheteur…"></textarea>
